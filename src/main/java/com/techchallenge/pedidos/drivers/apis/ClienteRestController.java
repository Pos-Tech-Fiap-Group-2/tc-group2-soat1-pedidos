...
import com.techchallenge.pedidos.adapter.driver.exceptionhandler.Problem;
...
@Api(tags = "Clientes")
@RestController
@RequestMapping(value = "/api/clientes", produces = MediaType.APPLICATION_JSON_VALUE, consumes = MediaType.APPLICATION_JSON_VALUE)
