...
public class ItemPedidoEntityMapperTest {

	@InjectMocks
	private ItemPedidoEntityMapper api;
	...
	public void toModel() {
		...
		when(mapper.map(itemPedido, ItemPedidoEntity.class)).thenReturn(entity);
		assertEquals(api.toModel(itemPedido), entity);
	}
